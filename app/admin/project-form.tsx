...
function CoverImageField({ defaultValue }: { defaultValue?: string }) {
  ...
  return (
    <div>
      <label className="text-xs uppercase tracking-[0.1em] text-muted">Cover image</label>
      <div className="mt-1.5 flex items-center gap-3">
        {value && (
          // eslint-disable-next-line @next/next/no-img-element
          <img src={value} alt="Cover preview" className="size-14 rounded-lg border border-border object-cover" />
        )}
